...
version='v2.24' # .xxxxx, .xxxxx, .xxxxx total variance in file, Lasso
...
version='v2.26' # .xxxxx, .xxxxx, .xxxxx total variance in file, LassoCV
...
def dofitSVMstd(X_train, Y_train, X_test):
    ...
    x[:,0]=X_train
    clf=LassoCV(cv = 15, copy_X = True, normalize = True)
