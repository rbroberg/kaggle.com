...
version='v2.09' # .92111, .88193, .xxxxxx entropy slope and intercept along channels
version='v2.10' # .91563, .88216, .xxxxxx entropy slope only along channels
...
version='v2.13' # .93118, .91263, .xxxxxx area under the curve, time under curve means in file
...
def dofitSVMstd(X_train, Y_train, X_test):
    ...
    for j in range(shape[0]):
        ...
        b.append(np.mean(np.array(pts),axis=0))
