...
version='v2.03' # .92585, .89338, .xxxxxx total variance in file
version='v2.04' # .90460, .86897, .xxxxxx variance vector across channels
version='v2.05' # .91517, .88274, .xxxxxx variance slope and intercept
version='v2.06' # .91783, .89700, .xxxxxx variance slope only
version='v2.07' # .92034, .88730, .xxxxxx variance slope and first value
version='v2.08' # .93118, .91263, .xxxxxx total entropy in file
version='v2.09' # .93118, .91263, .xxxxxx entropy slope and intercept along channels
version='v2.10' # .93118, .91263, .xxxxxx entropy slope only along channels
version='v2.11' # .93118, .91263, .xxxxxx entropy slope and intercept across channels
version='v2.12' # .93118, .91263, .xxxxxx entropy slope only across channels
...
def dofitSVMstd(X_train, Y_train, X_test):
    ...
    for j in range(shape[0]):
        a=[getEntropy(list(X_train[j,i,:].astype(int))) for i in range(shape[1])]
        a.sort(reverse=True)
        slope=np.polyfit(a,[i for i in range(len(a))],1)
        b.append([slope[0]])
    ...
    b=[]
    for j in range(shape[0]):
        a=[getEntropy(list(X_test[j,i,:].astype(int))) for i in range(shape[1])]
        a.sort(reverse=True)
        slope=np.polyfit(a,[i for i in range(len(a))],1)
        b.append([slope[0]])
